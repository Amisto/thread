...
FILE* flog = NULL;
char fname_dummy[100] = "chain_serialN_amplitude_%s.csv", fname[100];
...
double pulse_amplitude = 1E9;    //Pa, base - 5*10^9 Pa
...
int main(int argc, char** argv)
{
    ...
    for(pulse_amplitude = 4e9; pulse_amplitude < 1.55e10; pulse_amplitude += 5e8)
    //for(pulse_amplitude = 1e9; pulse_amplitude < 1.1e10; pulse_amplitude += 1e9)
        fprintf(flog, "%lf ", pulse_amplitude);
    fputc('\n', flog);

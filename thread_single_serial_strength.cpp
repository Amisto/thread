...
FILE* flog = NULL;
char fname_dummy[100] = "chain_serialN_strength_%s.csv", fname[100];
...
int main(int argc, char** argv)
{
    ...
    for(strength = 1.01; strength < 1.105; strength += 0.01)
    //for(pulse_amplitude = 1e9; pulse_amplitude < 1.1e10; pulse_amplitude += 1e9)
        fprintf(flog, "%lf ", strength);
    fputc('\n', flog);
